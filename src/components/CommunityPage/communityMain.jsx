...
export const CommunityForm = ({
  ...
  const { outID, check, titlea, image, link, view, like } = poster;
  ...
  const handleButton = async () => {
    try {
      const res = await axios.get(`http://4idiot.ddns.net:8080/community0`, {
        params: {
  ...
  return (
    <Container>
      ...
      <Heading style={{ textAlign: 'left' }}>인기글</Heading>
      ...
      <br />
      <br />
      <Heading style={{ textAlign: 'left' }}>전체글</Heading>
