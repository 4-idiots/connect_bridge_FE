...
export const projectGetNewService = () => {
  return customAxios.get(
    `${process.env.REACT_APP_MOON_URL}/api/project/page/new`,
  );
};
...
export const projectGetNoticeServie = projectID => {
  return customAxios.get(
    `${process.env.REACT_APP_MOON_URL}/api/project/${projectID}/notice`,
  );
};

export const projectNoticeUploadService = (projectID, content) => {
  return customAxios.post(
    `${process.env.REACT_APP_MOON_URL}/api/project/notice`,
    {
      projectID,
      content,
    },
...
export const projectGetAdminService = projectID => {
  return customAxios.get(
    `${process.env.REACT_APP_MOON_URL}/api/project/${projectID}/manage`,
  );
};

export const projectYesService = (projectID, submitID) => {
  return customAxios.get(
    `${process.env.REACT_APP_MOON_URL}/api/project/${projectID}/apply/${submitID}`,
  );
};

export const projectNoService = (projectID, submitID) => {
  return customAxios.get(
    `${process.env.REACT_APP_MOON_URL}/api/project/${projectID}/reject/${submitID}`,
  );
};
...
export const projectOutService = (projectID, memberID) => {
  return customAxios.get(
    `${process.env.REACT_APP_MOON_URL}/api/project/${projectID}/manage/fire/${memberID}`,
  );
};

export const filterProjectService = (area, field) => {
  return customAxios.get(
    `${process.env.REACT_APP_MOON_URL}/api/project/?projectField=${field}&projectArea=${area}`,
  );
};
